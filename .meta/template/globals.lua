...
---@deprecated Use events.createMessage()
...
--PLEASE USE EVENTS INSTEAD OF EVENT FOR THE SAKE OF CLARITY AND 38 API!
...
---@deprecated Use events.createSound()
...
---@deprecated Use events.createExplosion()
...
---@deprecated Use events.createBullet()
...
---@deprecated Use events.createBulletHit()
