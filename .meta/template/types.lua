do
	...
	---@field numEvents integer 🔒 How many networked events there currently are, resets to 0 when the server resets. [ Use events.getCount() for forward compatibility! ]
	local Server
...
do
	...
	function Vector3.length(vector) end
	...
	function Vector3.lengthSquare(vector) end
	...
	function Vector3.dotProduct(vector,otherVector) end
	...
	function Vector3.normalize(vector) end
end
